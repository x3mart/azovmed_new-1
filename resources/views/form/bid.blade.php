<form name="sendBid" method="post" action="/sendBid" accept-charset="UTF-8" id="indexForm1">
    ...
    <input type="submit" id="indexButton1" value="Заказать" onclick="e.preventDefault(); this.setAttribute('disabled', true); document.getElementById('indexForm1').submit();" style="position:absolute;left:27px;top:121px;width:249px;height:50px;z-index:29;">
</form>
